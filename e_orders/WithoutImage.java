...
public class WithoutImage extends Fragment {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup group, Bundle savedinstance){
        View view = inflater.inflate(R.layout.withoutimage_layout, group, false);

       // blurLayout = (BlurLayout)view.findViewById(R.id.blurlayout);
        oders_data.add(new Oders_data(" 10 kilos","123@gmail.com","1/2/3","https://res/*.cloudinary.com/hlkdbdswu/image/upload/v1525129044/Services/icons/Photography.pn*/g"));
        ...
        oders_data.add(new Oders_data(" 25 kilos","345@gmail.com","3/4/5","https://res./*cloudinary.c*/om/hlkdbdswu/image/upload/v1525129044/Services/icons/Photography.png"));
        ...
        RecyclerView recyclerView=(RecyclerView)view.findViewById(R.id.withoutimage_recycler);
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(linearLayoutManager);

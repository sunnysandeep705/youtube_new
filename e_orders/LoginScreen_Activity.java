...
public class LoginScreen_Activity extends AppCompatActivity {
   ...
   EditText logintext,passwordtext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminbtn = (TextView)findViewById(R.id.admin_text);
        newuserbtn = (TextView)findViewById(R.id.register_text);
        ...
        //   Snackbar.make(adminbtn,"asdasdasd",Snackbar.LENGTH_SHORT).show();
                Intent intent = new Intent(LoginScreen_Activity.this, Admin_Login.class);
        ...
        newuserbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginScreen_Activity.this,Signup_activity.class);
                    startActivity(intent);
            }
        });
    }
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (error.equals("Failure")){
                            ...
                            Intent intent = new Intent(LoginScreen_Activity.this, Orderscustomer_activity.class);
                           intent.putExtra("username", finalLoginstring);
